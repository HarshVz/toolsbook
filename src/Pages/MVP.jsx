        ...
        <>
            ...
            <div className='flex items-center justify-start w-full gap-3 overflow-x-auto'
                ...
                <div className="flex flex-nowrap gap-2 pb-2">
                    ...
                    <button
                        className={`
                            px-4 h-9 whitespace-nowrap rounded-2xl transition-all duration-200 ease-out
                            flex items-center gap-2 border font-medium text-sm
                            ${selectCategory?.toLowerCase() === "all"
                                ? "bg-neutral-800/80 text-neutral-100 border-neutral-700/60 shadow-sm"
                                : "text-neutral-400 border-neutral-800/50 hover:bg-neutral-800/30 hover:text-neutral-300 hover:border-neutral-700/60"
                            }
                        `}
                    ...
                    {categoryList.map(cat => (
                        <div
                            ...
                            className={`
                                px-4 h-9 whitespace-nowrap rounded-2xl transition-all duration-200 ease-out
                                flex items-center gap-2 border font-medium text-sm group capitalize cursor-pointer
                                ${selectCategory?.toLowerCase() === cat.name.toLowerCase()
                                    ? "bg-neutral-800/80 text-neutral-100 border-neutral-700/60 shadow-sm pr-2"
                                    : "text-neutral-400 border-neutral-800/50 hover:bg-neutral-800/30 hover:text-neutral-300 hover:border-neutral-700/60"
                                }
                            ...
                            {selectCategory?.toLowerCase() === cat.name.toLowerCase() && (
                                <button
                                    className="
                                        ...
                                        bg-neutral-700/60 border border-neutral-600/40 text-neutral-400
